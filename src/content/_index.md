+++
date = '2026-02-09T19:45:23+01:00'
draft = false
title = 'Home'
...
- 📊 [Status Page](https://status.carlossousa.tech/) 📊

Let's begin with one of the most useful projects - a Status Page. This [Gatus](https://github.com/TwiN/gatus) allows me to quickly check the status of my hosted services and provide transparency to others.

- ⌨️ [Lily58 Pro Keyboard](https://wiki.carlossousa.tech/doku.php?id=engineering:computer_science:projects:lily58_pro_diy_custom_keyboard) ⌨️

As a hardware and software enthusiast, I've [built two Lily58 Pro Keyboard]({{< relref "posts/keyboard-lily58-build-guide.md" >}}) - a wired version for home use and a wireless one for work. The [QMK and ZMK Firmware](https://github.com/carlos-sousa-tech/lily58_keyboard) is available for those interested in creating their own Lily 58 Pro Keyboard variant.
...
- 📚 [Archive](http://archive.carlossousa.tech/) 📚

My Archive preserves articles I want to reference or revisit, preventing them from being lost to the transient nature of the internet. Powered by [ArchiveBox](https://archivebox.io/) (though I have my reservations about it).
...
- 🌐 [HUGO Website - this website itself!](https://github.com/carlos-sousa-tech/website-hugo) 🌐

The [previous one was built with React](https://github.com/carlos-sousa-tech/website-react) if you want to look at it.

- 🐳 [LAMPinDocker](https://github.com/carlos-sousa-tech/LAMPinDocker) 🐳
...
You can also check [the post on the building guide]({{< relref "posts/keyboard-lily58-build-guide.md" >}}).
...
- 🗂️ [Docker Stack Backupper](https://github.com/carlos-sousa-tech/docker-stack-backupper) 🗂️
...
- 🗺️ [Travel Tracer](https://github.com/carlos-sousa-tech/travel-tracer) 🗺️

A React application that uses Leaflet and GeoJSON data to display places I've traveled to or want to visit.

Check out the [Live Version](https://travel.carlossousa.tech/) if you want.
...
🎮 [Steam - csousa90](https://steamcommunity.com/id/csousa90/) 🎮

🐙 [GitHub - carlos-sousa-tech](https://github.com/carlos-sousa-tech/) 🐙

🎵 [Last.fm - zebrajr](https://www.last.fm/user/zebrajr) 🎵
